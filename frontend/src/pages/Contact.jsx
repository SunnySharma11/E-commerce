          ...
          <div className="tw:mt-[95px]">
            <div className="tw:mb-[40px]">
              <span className="tw:flex tw:mb-[15px]">
                <i className="fa-solid fa-location-dot tw:mt-[4px]"></i>
            ...
            <div className="tw:mb-[40px]">
              <span className="tw:flex tw:mb-[15px]">
                <i className="fa-solid fa-phone tw:mt-[6px]"></i>
                <h5 className="tw:ml-[18px]">Let's Talk</h5>
              </span>
              <p className="tw:ml-[30px]">+91 0000000000</p>
            </div>
            <div className="tw:mb-[40px]">
              <span className="tw:flex tw:mb-[15px]">
                <i className="fa-solid fa-message tw:mt-[6px]"></i>
